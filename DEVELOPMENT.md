...
```bash
git remote add encore encore://automotive-calculator-app-yeu2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/automotive-calculator-app-yeu2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/automotive-calculator-app-yeu2/settings/integrations/github)
